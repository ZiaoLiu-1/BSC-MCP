...
const scriptPath = path.resolve(__dirname, '../../check_tron.py');

/**
 * Execute the check_tron.py script with the provided arguments
...
/**
 * Get top traders for a specific token on Tron using the Python implementation
 ...
 */
export async function getTopTradersGMGNTron(tokenAddress, limit = 100, orderBy = 'profit', direction = 'desc') {
...
/**
 * Get top traders for multiple tokens on Tron in a single call
 ...
 */
export async function getMultipleTopTradersGMGNTron(tokenAddresses, limit = 5, orderBy = 'profit', direction = 'desc') {
  // Validate input
...
/**
 * Get token trades on Tron from GMGN
 * @param {string} tokenAddress - Token contract address
 ...
 */
export async function getTokenTradesGMGNTron(
  tokenAddress, 
  fromTimestamp = 0, 
